...
Shader::Shader(std::string& vertexShaderSrc, std::string& fragmentShaderSrc) : m_RendererID(0)
{
	...
	if (isCompiled == GL_FALSE)
	{
		...
		std::cout << "Vertex Shader didn't compile successfully" << std::endl;
	...
	if (isCompiled == GL_FALSE)
	{
		...
		// Use the infoLog as you see fit.
		std::cout << "Fragment Shader didn't compile successfully" << std::endl;
		// In this simple program, we'll just leave
		return;
	}
	else
	...
	if (isLinked == GL_FALSE)
	{
		...
		// Use the infoLog as you see fit.
		std::cout << "Shaders didn't link successfully" << std::endl;
		// In this simple program, we'll just leave
		return;
	}
	else
